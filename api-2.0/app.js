...
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        var channelDestination = req.body.channelDestination;
        var args = req.body.args;
        var transient = req.body.transient;
        console.log(`Transient data is ;${transient}`);
        logger.debug('channelName  : ' + channelName);
        logger.debug('chaincodeName : ' + chaincodeName);
        logger.debug('channelDestination : ' + channelDestination);
        ...
        if (!channelDestination) {
            res.json(getErrorMessage('\'channelDestination\''));
            return;
        }
        if (!args) {
        ...
        let message = await invoke.invokeTransaction(channelName, channelDestination, chaincodeName, fcn, args, req.username, req.orgname, transient);
...
app.get('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        let channelDestination = req.query.channelDestination;
        ...
        let message = await query.query(channelName, channelDestination, chaincodeName, args, fcn, req.username, req.orgname);
